...
class Arena {
  ...
  */
  ...
  /**
   * @brief Get the # of obstacles in Arena.
   *
  ...
  /**
   * @brief Get a list of all robots in Arena.
   *
   * @return Pointers to robots in a vector.
   */
  std::vector<class Robot*> robots();  // 11/28
  ...
  /**
   * @brief Get the super_bot in Arena.
   *
   * @return A pointer to the super_bot.
   */
  // class SuperBot *super_bot() const { return super_bot_; }
  ...
  /**
   * @brief return distance of two objects.
   */
 ...
 /**
  * @brief to check the entitytype sensor is detect something.
  *
  * @param ent1 The Robot who is checking.
  * @param ent2 the Arena Eentity to check
  * @param sen1 Pointer to a sensor.
  * @param et Pointer to Event.
  *
  */
  ...
  // EntityTypeSensor *ets_;
  // SuperBot *super_bot_;
  std::vector<class Robot*> robots_;  // 11/28
