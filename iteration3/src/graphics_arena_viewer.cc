...
void GraphicsArenaViewer::DrawPlayer(NVGcontext *ctx,
  ...
  // player's circle
  nvgBeginPath(ctx);
  nvgCircle(ctx, 0.0, 0.0, static_cast<float>(player->get_radius()));
  nvgFillColor(ctx,
...
//             static_cast<float>(super->get_radius()));
//   nvgFillColor(ctx,
...
void GraphicsArenaViewer::DrawObstacle(NVGcontext *ctx,
  ...
  nvgCircle(ctx,
            ...
            static_cast<float>(obstacle->get_radius()));
  nvgFillColor(ctx,
...
void GraphicsArenaViewer::DrawHomeBase(NVGcontext *ctx,
  ...
  nvgCircle(ctx,
            ...
            static_cast<float>(home->get_radius()));
  nvgFillColor(ctx,
...
void GraphicsArenaViewer::DrawRobot(NVGcontext *ctx,
  ...
  nvgCircle(ctx,
            ...
            static_cast<float>(r->get_radius()));
  nvgFillColor(ctx,
...
void GraphicsArenaViewer::DrawSensors(NVGcontext *ctx, const Robot* const r,
  ...
  nvgRotate(ctx, -(r->get_heading_angle()));
