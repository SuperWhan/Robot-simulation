...
#ifndef PROJECT_ITERATION3_SRC_ENTITY_TYPE_SENSOR_H_
#define PROJECT_ITERATION3_SRC_ENTITY_TYPE_SENSOR_H_
...
#endif  // PROJECT_ITERATION3_SRC_ENTITY_TYPE_SENSOR_H_
