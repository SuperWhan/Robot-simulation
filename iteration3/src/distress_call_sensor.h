...
#ifndef PROJECT_ITERATION3_SRC_DISTRESS_CALL_SENSOR_H_
#define PROJECT_ITERATION3_SRC_DISTRESS_CALL_SENSOR_H_
...
#endif  // PROJECT_ITERATION3_SRC_DISTRESS_CALL_SENSOR_H_
